...
public:
    ...
    /// [myproject/BLACK-BOX]:一键设置当前点为home点
    /// Set home to vehicle current position (uses vehicle altitude instead of terrain altitude)
    Q_INVOKABLE void doSetHomeToVehiclePosition();
...
private:
    ...
    /// [myproject/BLACK-BOX]:一键设置当前点为home点 - 回调处理函数
    static void _doSetHomeToVehiclePositionAckHandler(void* resultHandlerData, int compId, const mavlink_command_ack_t& ack, MavCmdResultFailureCode_t failureCode);
