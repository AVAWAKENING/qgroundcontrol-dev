...
protected:
    ...
    void _handleBlackboxLowBandwidthPosition(const mavlink_message_t &message);
    void _handleBlackboxLowBandwidthStatus(Vehicle *vehicle, const mavlink_message_t &message);
